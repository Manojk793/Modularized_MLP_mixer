...
class MixerBlock(nn.Module):
    def _init_(self, num_patches, hidden_dim, token_dim, channel_dim, dropout=0.1):
        super(MixerBlock, self)._init_()
...
class MLPMixer(nn.Module):
    def _init_(self, num_classes, num_blocks=8, num_patches=196, hidden_dim=512, token_dim=256, channel_dim=2048):
        super(MLPMixer, self)._init_()
